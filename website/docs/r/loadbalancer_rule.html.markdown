...
* `backend_address_pool_id` - (Required) A reference to a Backend Address Pool over which this Load Balancing Rule operates.
* `probe_id` - (Required) A reference to a Probe used by this Load Balancing Rule.
